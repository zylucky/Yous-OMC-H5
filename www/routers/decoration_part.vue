<style scoped lang="less">
  * {
  ...
  .ys_item_ul li {
    ...
    .sub-ul {
      padding: .24rem .70rem .16rem .70rem;
      li {
        padding-left: 0;
        float: left;
    ...
    <div class="build_top">
      <ul class="ys_item_ul mb20">
        <li class="clearfix color_black bd">
          ...
          <button class="edit">签到</button>
        </li>
        <li class="clearfix">
          <ul class="sub-ul clearfix">
            <li class="current"><span>岗位</span> <span>姓名1</span></li>
            <li><span>岗位</span> <span>姓名2</span></li>
            <li><span>岗位</span> <span>姓名3</span></li>
            <li><span>岗位</span> <span>姓名4</span></li>
          </ul>
        </li>
      </ul>
        <div class="common_title">户型图(0/1)</div>
        <div  class="image_wrap clearfix mb140">
          <div class="upload_btn mr10 fl"></div>
          <div class="img_demo fl pr">
            <img src="/static/img/demo_img.9ee0b97.png" alt="" class="upload_demo_img">
          <i class="delete_icon"></i>
          </div>
        </div>
      <div class="common_title">灯光方位图(0/1)</div>
      <div  class="image_wrap clearfix mb140">
        <div class="upload_btn mr10 fl"></div>
        <div class="img_demo fl pr">
          <img src="/static/img/demo_img.9ee0b97.png" alt="" class="upload_demo_img">
      ...
      <div class="common_title">房间效果图(0/1)</div>
      <div  class="image_wrap clearfix mb140">
        <div class="upload_btn mr10 fl"></div>
        <div class="img_demo fl pr">
          <img src="/static/img/demo_img.9ee0b97.png" alt="" class="upload_demo_img">
      ...
      <button class="save current">保存</button>
    </div>
</template>
<script>
