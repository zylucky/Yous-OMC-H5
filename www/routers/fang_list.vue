  ...
  .float-part {
    ...
    .bulid_msg_item {
      ...
      i {
        ...
        &.basic_15 {
          background: url("../resources/images/icons/basic_icon/basic15.png") no-repeat;
          background-size: .65rem .55rem;
        }
        &.basic_16 {
  ...
  <div>
    ...
    <div class="float-part" id="msg_super_wrap">
      <div class="line-one clearfix">
        <router-link class="bulid_msg_item" :to="{path:'/fang_basic/'+fid}" >
          <i class="basic_01"></i>
          <span>基本信息</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_struct/'+fid}">
          <i class="basic_19"></i>
          <span>构造信息</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_owner/'+fid}">
          <i class="basic_17"></i>
          <span>业主信息</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_agenter/'+fid}">
          <i class="basic_16"></i>
          <span>代理人信息</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_renter/'+fid}">
          <i class="basic_15"></i>
          <span>租户信息</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_image/'+fid}">
          <i class="basic_06"></i>
          <span>图片信息</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_analyse/'+fid}">
          <i class="basic_14"></i>
          <span>房源分析</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_decor/'+fid}">
          <i class="basic_18"></i>
          <span>装修状况</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_reg/'+fid}">
          <i class="basic_13"></i>
          <span>注册信息</span>
        </router-link>
        <router-link class="bulid_msg_item" :to="{path:'/fang_rent/'+fid}">
          <i class="basic_07"></i>
          <span>出租状态</span>
        </router-link>
      </div>
