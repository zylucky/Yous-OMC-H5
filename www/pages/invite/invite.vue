				...
				var _this = this;
		      	wx.ready(()=>{
					wx.onMenuShareAppMessage({
					    title: "亮狮网渠道注册", // 分享标题
					    desc: "一键注册成为亮狮网渠道合作伙伴", // 分享描述
					    link: _this.$url_share + _this.$route.query.invitecode,
					...
					wx.onMenuShareTimeline({
					    title: "亮狮网渠道注册", // 分享标题
					    link: _this.$url_share + _this.$route.query.invitecode, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
					    imgUrl: 'http://omc.urskongjian.com:81/yskjapp/shi_ion.png', // 分享图标
					    success: function () { 
