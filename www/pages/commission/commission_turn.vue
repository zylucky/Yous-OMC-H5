<style scoped lang='less'>
	...
	.new_box{
		...
		.icon{
			...
			width: 1.45rem;
			height: 1.45rem;
			background: url(../../resources/images/commission/turn_icon.png) no-repeat center;
			...
			<div class="pop_box" v-if="popshow" @click="popbox">
				<div class="pop">
					...
					<ul>
						...
						<li>
							<p>地址：</p>
							<p>北京市朝阳区东三环中路39号建外SOHO24号楼22层2602</p>
						</li>
						<li>
							<p>开户银行：</p>
							<p>招商银行北京分行建国门支行</p>
